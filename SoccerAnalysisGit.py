...
data = data[data.isin(m)]# | data.isin(extra)]
data = data[data['Minutes'] >= 900]
columns = []
for i in list(data.columns):
    if i != 'Name' and i != 'MarketValue' and i != 'Birthday(DD/MM/YYYY)' and i != 'Team' and i != 'Position' and i != 'GoalKeeper' and i != 'Substitute' and i != 'Midfielder':
        columns.append(i)
...
clf = sklearn.linear_model.Lasso(random_state=88,normalize=True)
...
grid_values = {'alpha': np.arange(0,5,0.01)} 
lasso = sklearn.linear_model.Lasso(random_state=88,normalize=True)
...
clf = sklearn.linear_model.Lasso(lasso_cv1.best_params_['alpha'],random_state=88,normalize=True)
clf.fit(X_train,y_train)
y_pred = clf.predict(X_train)
print('Training R-Squared:', sklearn.metrics.r2_score(y_train,y_pred))
print('Training MSE:', sklearn.metrics.mean_squared_error(y_train,y_pred))
...
clf = sklearn.linear_model.Lasso(lasso_cv.best_params_['alpha'],random_state=88,normalize=True)
clf.fit(X_train,y_train)
y_pred = clf.predict(X_train)
print('Training R-Squared:', sklearn.metrics.r2_score(y_train,y_pred))
print('Training MSE:', sklearn.metrics.mean_squared_error(y_train,y_pred))
...
clf = sklearn.linear_model.Ridge(random_state=88,normalize=True)
clf.fit(X_train,y_train)
y_pred = clf.predict(X_train)
print('Training R-Squared:', sklearn.metrics.r2_score(y_train,y_pred))
print('Training MSE:', sklearn.metrics.mean_squared_error(y_train,y_pred))
...
grid_values = {'alpha':  np.arange(0,5,0.01)} 
ridge = sklearn.linear_model.Ridge(random_state=88,normalize=True)
cv = KFold(n_splits=5,random_state=333,shuffle=True) 
...
clf = sklearn.linear_model.Ridge(ridge_cv1.best_params_['alpha'],random_state=88,normalize=True)
clf.fit(X_train,y_train)
y_pred = clf.predict(X_train)
print('Training R-Squared:', sklearn.metrics.r2_score(y_train,y_pred))
print('Training MSE:', sklearn.metrics.mean_squared_error(y_train,y_pred))
...
#Train and test optimized model on the data
clf = sklearn.linear_model.Ridge(ridge_cv.best_params_['alpha'],random_state=88,normalize=True)
clf.fit(X_train,y_train)
y_pred = clf.predict(X_train)
print('Training R-Squared:', sklearn.metrics.r2_score(y_train,y_pred))
print('Training MSE:', sklearn.metrics.mean_squared_error(y_train,y_pred))
...
clf = sklearn.linear_model.ElasticNet(random_state=88,normalize=True)
clf.fit(X_train,y_train)
y_pred = clf.predict(X_train)
print('Training R-Squared:', sklearn.metrics.r2_score(y_train,y_pred))
print('Training MSE:', sklearn.metrics.mean_squared_error(y_train,y_pred))
...
grid_values = {'alpha':  np.arange(0,1,0.01),
              'l1_ratio': np.arange(0,1.01,0.1)
              } 
en = sklearn.linear_model.ElasticNet(random_state=88,normalize=True)
cv = KFold(n_splits=5,random_state=333,shuffle=True) 
...
clf = sklearn.linear_model.ElasticNet(alpha=en_cv1.best_params_['alpha'],l1_ratio=en_cv1.best_params_['l1_ratio'],random_state=88,normalize=True)
clf.fit(X_train,y_train)
y_pred = clf.predict(X_train)
print('Training R-Squared:', sklearn.metrics.r2_score(y_train,y_pred))
print('Training MSE:', sklearn.metrics.mean_squared_error(y_train,y_pred))
...
#Train and test model on data
clf = sklearn.linear_model.ElasticNet(alpha=en_cv.best_params_['alpha'],l1_ratio=en_cv.best_params_['l1_ratio'],random_state=88,normalize=True)
clf.fit(X_train,y_train)
y_pred = clf.predict(X_train)
print('Training R-Squared:', sklearn.metrics.r2_score(y_train,y_pred))
print('Training MSE:', sklearn.metrics.mean_squared_error(y_train,y_pred))
...
#Show top 10 most underrated midfielders
